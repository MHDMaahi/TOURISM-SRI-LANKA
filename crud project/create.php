    ...
    <div class="container my-5">
        ...
        <form action="" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="number" name="number" class="form-control" placeholder="Client Phone Number" required>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="date" name="date" class="form-control" placeholder="Client Date Of Birth" required>
                </div>
            </div>
            <div class="row mb-3">
